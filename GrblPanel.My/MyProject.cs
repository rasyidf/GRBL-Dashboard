	...
	internal sealed class MyProject
	{
		...
		internal sealed class MyForms
		{
			...
			public GrblGui GrblGui
			{
				get
				{
					this.m_GrblGui = MyProject.MyForms.Create__Instance__<GrblGui>(this.m_GrblGui);
					return this.m_GrblGui;
				}
				set
				{
					if (value != this.m_GrblGui)
					{
						if (value != null)
						{
							throw new ArgumentException("Property can only be set to Nothing");
						}
						this.Dispose__Instance__<GrblGui>(ref this.m_GrblGui);
					}
				}
			}
			[DebuggerHidden]
